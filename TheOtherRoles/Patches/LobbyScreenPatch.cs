            ...
            if (LobbyText)
            {
                ...
                if (GameId != 0 && GameId != 32)
                {
                    ...
                    if (code != "")
                    {
                        ...
                        LobbyText.GetComponent<TMPro.TextMeshPro>().text = string.Format(ModTranslation.GetString("lobbyText", 1), code);

                    }
                }
                if (code2 != "")
                {
                    LobbyText.GetComponent<TMPro.TextMeshPro>().text += string.Format(ModTranslation.GetString("lobbyText", 2), code2Disp);
                }
            }
        }
    }
