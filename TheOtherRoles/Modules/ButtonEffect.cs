    ...
    public static class ButtonEffect
    {
        ...
        static public void ShowVanillaKeyGuide(this HudManager manager)
        {
            ...
            if (actionArray.Count > 0)
            {
                ...
                SetKeyGuide(HudManager.Instance.SabotageButton.gameObject, actionMap.keyCode, action: TranslationController.Instance.GetString(StringNames.SabotageLabel).camelString());
            }
            ...
            {
                actionMap = actionArray[0];
                SetKeyGuide(HudManager.Instance.UseButton.gameObject, actionMap.keyCode, action: TranslationController.Instance.GetString(StringNames.UseLabel).camelString());
                SetKeyGuide(HudManager.Instance.PetButton.gameObject, actionMap.keyCode, action: TranslationController.Instance.GetString(StringNames.PetLabel).camelString());
            }
            ...
            {
                actionMap = actionArray[0];
                SetKeyGuide(HudManager.Instance.ReportButton.gameObject, actionMap.keyCode, action: TranslationController.Instance.GetString(StringNames.ReportLabel).camelString());
            }
            ...
            {
                actionMap = actionArray[0];
                SetKeyGuide(HudManager.Instance.KillButton.gameObject, actionMap.keyCode, action: TranslationController.Instance.GetString(StringNames.KillLabel).camelString());
            }
            ...
            {
                actionMap = actionArray[0];
                SetKeyGuide(HudManager.Instance.ImpostorVentButton.gameObject, actionMap.keyCode, action: TranslationController.Instance.GetString(StringNames.VentLabel).camelString());
            }
        }
    }
}
