...
namespace TheOtherRoles
{
    public class CustomOptionHolder
    {
        ...
        public static void Load()
        {
            ...
            // Modifier (1000 - 1999)
            modifiersAreHidden = CustomOption.Create(1009, Types.Modifier, new TranslationInfo("Opt-General", 56, Color.yellow), true, null, true, heading: new TranslationInfo("Opt-General", 122, Color.yellow));
            ...
            modifierDisperserNumberOfUses = CustomOption.Create(2202, Types.Modifier, new TranslationInfo("Opt-Disperser", 2), 1, 1, 20, 1, modifierDisperser);
            ...
            guesserForceJackalGuesser = CustomOption.Create(2007, Types.Guesser, new TranslationInfo("Opt-Guessers-General", 4), false, null, true, heading: new TranslationInfo("Opt-General", 112));
            ...
            guesserGamemodeHaveModifier = CustomOption.Create(2004, Types.Guesser, new TranslationInfo("Opt-Guessers-General", 5), true, null, true, heading: new TranslationInfo("Opt-General", 113));
            ...
            hunterLightCooldown = CustomOption.Create(3005, Types.HideNSeekRoles, new TranslationInfo("Opt-HideNSeek-Roles", 1, Color.red), 30f, 5f, 60f, 1f, null, true, heading: new TranslationInfo("Opt-General", 114));
            ...
            huntedShieldCooldown = CustomOption.Create(3015, Types.HideNSeekRoles, new TranslationInfo("Opt-HideNSeek-Roles", 11, Color.gray), 30f, 5f, 60f, 1f, null, true, heading: new TranslationInfo("Opt-General", 115));
            ...
            propHuntTimer = CustomOption.Create(4021, Types.PropHunt, new TranslationInfo("Opt-PropHunt-General", 1, Color.yellow), 5f, 1f, 30f, 0.5f, null, true, heading: new TranslationInfo("Opt-General", 116));
            ...
            // Hunter Options
            propHuntNumberOfHunters = CustomOption.Create(4000, Types.PropHunt, new TranslationInfo("Opt-PropHunt-Hunter", 1, Color.red), 1f, 1f, 5f, 1f, null, true, heading: new TranslationInfo("Opt-General", 117));
            ...
            // Prop Options
            propBecomesHunterWhenFound = CustomOption.Create(4003, Types.PropHunt, new TranslationInfo("Opt-PropHunt-Prop", 1, Palette.CrewmateBlue), false, null, true, heading: new TranslationInfo("Opt-General", 118));
            ...
            // Other options
            maxNumberOfMeetings = CustomOption.Create(3, Types.General, new TranslationInfo("Opt-General", 57), 10, 0, 15, 1, null, true, heading: new TranslationInfo("Opt-General", 119));
            ...
            camsNightVision = CustomOption.Create(511, Types.General, new TranslationInfo("Opt-General", 100), false, null, true, heading: new TranslationInfo("Opt-General", 120));
            ...
            dynamicMap = CustomOption.Create(500, Types.General, new TranslationInfo("Opt-General", 63), true, null, false, heading: new TranslationInfo("Opt-General", 121));
